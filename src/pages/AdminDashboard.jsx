      ...
      <DashboardGrid>
        ...
        <Card>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <StatusBadge color="#22C55E">완료: {stats.completedProjects}</StatusBadge>
            <StatusBadge color="#3B82F6">진행중: {stats.inProgressProjects}</StatusBadge>
            <StatusBadge color="#EAB308">보류: {stats.onHoldProjects}</StatusBadge>
          </div>
