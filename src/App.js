    ...
    <AppContainer>
      ...
      <MainContentWrapper $isLoginPage={isLoginPage}>
        <Routes>
          ...
          <Route path="/user/inquiries" element={<ProtectedRoute><UserInquiryList /></ProtectedRoute>} />
          ...
          <Route path="/project-create" element={<ProtectedRoute><ProjectCreate /></ProtectedRoute>} />
          ...
          <Route path="/project/:projectId/approval/:approvalId" element={<ProtectedRoute><ApprovalDetail /></ProtectedRoute>} />
